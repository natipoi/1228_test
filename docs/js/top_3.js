  ...
  var lineChart2 = new Chart(ctx3, {
    ...
    data: {
      ...
      datasets: [{
          ...
          lineTension: 0,
          yAxisID: 'y-axis-1',
          data: [300000, 390000, 350000, 390000, 310000, 310000, 350000, 390000, 290000, 350000, 320000, 310000],
        },
        {
          backgroundColor: 'rgba(0, 0, 0, 0)',
          borderColor: '#eeeeee',
          ...
          lineTension: 0,
          yAxisID: 'y-axis-1',
          data: [260000, 350000, 320000, 360000, 280000, 280000, 320000, 360000, 260000, 320000, 290000, 280000],
        },
        {
          backgroundColor: 'rgba(0, 0, 0, 0)',
          borderColor: '#d2d2d2',
          ...
          lineTension: 0,
          yAxisID: 'y-axis-2',
          data: [100000, 120000, 110000, 90000, 110000, 120000, 130000, 80000, 60000, 120000, 90000, 150000],
        },
        {
          backgroundColor: 'rgba(0, 0, 0, 0)',
          borderColor: '#eeeeee',
          ...
          lineTension: 0,
          yAxisID: 'y-axis-2',
          data: [80000, 100000, 90000, 70000, 90000, 100000, 110000, 60000, 40000, 100000, 70000, 130000],
        },
        {
          backgroundColor: 'rgba(0, 0, 0, 0)',
          borderColor: '#d2d2d2',
          ...
          lineTension: 0,
          yAxisID: 'y-axis-3',
          data: [500000, 450000, 490000, 410000, 500000, 410000, 390000, 410000, 450000, 480000, 400000, 490000],
        },
        {
          backgroundColor: 'rgba(0, 0, 0, 0)',
          borderColor: '#eeeeee',
          ...
          lineTension: 0,
          yAxisID: 'y-axis-3',
          data: [470000, 420000, 460000, 380000, 470000, 380000, 360000, 380000, 420000, 450000, 370000, 460000],
        },
      ]
    },
    options: {
